...
public class Exercise1 {
    ...
    public static void main(String[] args) {
       ...
       int [] newArray1= myArray1.clone();
        ...
        String [] newArray2 = myArray2.clone();
        Arrays.sort(newArray2);


        System.out.println("Original numeric array : " + Arrays.toString(myArray1));
        //Sort array
       System.out.println("Sorted numeric array : " + Arrays.toString(newArray1));

      System.out.println("Original string array : " +Arrays.toString(myArray2));
      //Sort array
       System.out.println("Sorted string array : " + Arrays.toString(newArray2));
